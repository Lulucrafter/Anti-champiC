...
import net.mcreator.antichanpi.entity.renderer.RogerRenderer;
import net.mcreator.antichanpi.AntichanpiModElements;

@AntichanpiModElements.ModElement.Tag
public class RogerEntity extends AntichanpiModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.5f, 0.5f)).build("roger").setRegistryName("roger");
	public RogerEntity(AntichanpiModElements instance) {
		super(instance, 47);
		FMLJavaModLoadingContext.get().getModEventBus().register(new RogerRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -13421773, -10452553, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("roger_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 5;
			setNoAI(false);
			setCustomName(new StringTextComponent("roger"));
