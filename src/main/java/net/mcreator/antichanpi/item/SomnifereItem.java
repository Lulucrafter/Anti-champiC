...
public class SomnifereItem extends AntichanpiModElements.ModElement {
	@ObjectHolder("antichanpi:somnifere")
	public static final Item block = null;
	public SomnifereItem(AntichanpiModElements instance) {
		super(instance, 37);
	}
