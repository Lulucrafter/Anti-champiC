...
package net.mcreator.antichanpi.world.biome;
...
public class MushroomCBiome extends AntichanpiModElements.ModElement {
	public static Biome biome;
	public MushroomCBiome(AntichanpiModElements instance) {
		super(instance, 34);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-26215).setWaterColor(-8250597).setWaterFogColor(-10092544)
						.withSkyColor(-26215).withFoliageColor(10387789).withGrassColor(-10068900)
						.setParticle(new ParticleEffectAmbience(ParticleTypes.FALLING_LAVA, 0.005f)).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.MUSHROOM_STEM.getDefaultState()),
								new SimpleBlockStateProvider(Blocks.RED_MUSHROOM_BLOCK.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("antichanpi:mushroom_c"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("mushroom_c_lvtd");
		...
		protected void func_227424_a_(IWorldWriter ww, BlockPos bp, BooleanProperty bpr, Set<BlockPos> sbc, MutableBoundingBox mbb) {
			this.func_227423_a_(ww, bp, Blocks.RED_MUSHROOM_BLOCK.getDefaultState(), sbc, mbb);
		}
	}
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("mushroom_c_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("mushroom_c_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
